/*
  Leitura de tensão (mV) de sensor ISE de nitrato
  ESP32 + entrada analógica GPIO 33
  ...
  Conexão:
  Saída analógica do circuito condicionador do ISE -> GPIO 33
  GND -> GND do ESP32
...
void setup() {
  ...
  // Atenuação:
  // ADC_11db permite leitura até aproximadamente 3.3 V
  analogSetPinAttenuation(pinoISE, ADC_11db);

  Serial.println("Leitura sensor ISE de nitrato");
}
